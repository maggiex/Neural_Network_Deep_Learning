...
class KNN(object):
  ...
  def compute_L2_distances_vectorized(self, X):
    ...
    Xtr = np.sum(self.X_train**2, axis = 1)              # (5000, 3072) --> (5000, ^2) --> (5000, sum) --> (5000,)
    Xte = np.sum(X**2, axis = 1).reshape(X.shape[0], 1)  # (500, 3072) --> (500, ^2) --> (500, sum) --> (500,)--> (500, 1)
    dists = np.sqrt(Xtr + Xte - 2*X.dot(self.X_train.T))  #(5000,)+(500,1) --->(500, 5000)
    #pass
